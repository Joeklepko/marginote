...
check('14 寸最大化窗口保持单行', !core.shouldUseCompactToolbar(968));
...
const reading = core.readingLayout(2);
check('阅读模式真实缩放整个版面', reading.zoom === '2.00' && reading.maxWidth === '380.00px');
check('阅读模式反向补偿留白', reading.padding === '40.00px 16.00px 80.00px');
